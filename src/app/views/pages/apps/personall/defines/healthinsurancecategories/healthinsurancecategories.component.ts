...
@Component({
  selector: 'kt-healthinsurancecategories',
  templateUrl: './healthinsurancecategories.component.html',
  styleUrls: ['./healthinsurancecategories.component.scss']
})
export class HealthinsurancecategoriesComponent implements OnInit {
  ...
  goBack(id) {
	...
	getComponentTitle() {
		let result = 'new heath insurance categories';
