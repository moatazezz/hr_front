...
@Component({
  selector: 'kt-educational-organization',
  templateUrl: './educational-organization.component.html',
  styleUrls: ['./educational-organization.component.scss']
})
export class EducationalOrganizationComponent implements OnInit {
  ...
  goBack(id) {
	...
	getComponentTitle() {
		let result = 'new educational orignization';
