...
@Component({
  selector: 'kt-faculity',
  templateUrl: './faculity.component.html',
  styleUrls: ['./faculity.component.scss']
})
export class FaculityComponent implements OnInit {
  ...
  AVAILABLE_EDUCATIONALORIGNISATION: string[];
  constructor(
  ...
  ngOnInit() {
    this.AVAILABLE_EDUCATIONALORIGNISATION=['Orgnisation1','Orignization2','One','Two','Three'];
    ...
    eductionalorginaztion: [this.product.model, Validators.required],
