...
@Component({
  selector: 'kt-importingleavebalances',
  templateUrl: './importingleavebalances.component.html',
  styleUrls: ['./importingleavebalances.component.scss']
})
export class ImportingleavebalancesComponent implements OnInit {
  ...
  private subheaderService: SubheaderService,
	...
	this.getfile=fileInputEvent.target.files[0].name;
  ...
  ngOnInit() {
	...
	balances: [this.product.model],
	currentbalance: [this.product.model],
	nextbalance: [this.product.model],
		});
