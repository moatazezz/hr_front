...
@Component({
  selector: 'kt-summaryofmonthlyvacations',
  templateUrl: './summaryofmonthlyvacations.component.html',
  styleUrls: ['./summaryofmonthlyvacations.component.scss']
})
export class SummaryofmonthlyvacationsComponent implements OnInit {
  ...
  AVAILABLE_SECTOR: string[];
  AVAILABLE_ADMINISTRATOR: string[];
  AVAILABLE_DEPARTMENT: string[];
  AVAILABLE_INCLUDESDATAINEES: string[];
  constructor(
  ...
  ngOnInit() {
  this.AVAILABLE_SECTOR=['ONE','TWO','THREE'];
  this.AVAILABLE_ADMINISTRATOR=['ONE','TWO','THREE'];
  this.AVAILABLE_DEPARTMENT=['ONE','TWO','THREE'];
  this.AVAILABLE_INCLUDESDATAINEES=['AHMED','toto','bobo'];
    ...
    selector: [this.product.model],
    administrator: [this.product.model],
	department: [this.product.model],
	financialyear: [this.product.model],
	includesdatainees: [this.product.model],
		});
