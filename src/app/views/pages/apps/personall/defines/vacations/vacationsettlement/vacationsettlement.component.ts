...
@Component({
  selector: 'kt-vacationsettlement',
  templateUrl: './vacationsettlement.component.html',
  styleUrls: ['./vacationsettlement.component.scss']
})
export class VacationsettlementComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    settlementdate: [this.product.model],
    ...
    yearstartbalance: [this.product.model],
	currentbalance: [this.product.model],
	balancerelay: [this.product.model],
		});
