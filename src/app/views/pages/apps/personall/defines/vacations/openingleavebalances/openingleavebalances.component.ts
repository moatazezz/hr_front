...
@Component({
  selector: 'kt-openingleavebalances',
  templateUrl: './openingleavebalances.component.html',
  styleUrls: ['./openingleavebalances.component.scss']
})
export class OpeningleavebalancesComponent implements OnInit {
  ...
  goBack(id) {
	...
	getComponentTitle() {
		let result = 'new Opening Leave Collective';
