...
@Component({
  selector: 'kt-vactionorder',
  templateUrl: './vactionorder.component.html',
  styleUrls: ['./vactionorder.component.scss']
})
export class VactionorderComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    dateOfregisteration: [this.product.model],
    employeecode: [this.product.model],
    employeename: [this.product.model],
    employeejob: [this.product.model],
    employeeadministration: [this.product.model],
    employeedepartment: [this.product.model],
    employeehiringdate: [this.product.model],
    employeemounthnumberhiring: [this.product.model],
    employeedaynumberofvacation: [this.product.model],
	creditsbox: [this.product.model],
	vacationtype: [this.product.model],
	dateOfstartingvacation: [this.product.model],
	dateOfendingvacation: [this.product.model],
	reason: [this.product.model],
	alternativeemployee: [this.product.model],
	phone: [this.product.model],
