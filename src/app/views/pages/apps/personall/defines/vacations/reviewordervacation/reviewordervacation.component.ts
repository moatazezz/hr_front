...
@Component({
  selector: 'kt-reviewordervacation',
  templateUrl: './reviewordervacation.component.html',
  styleUrls: ['./reviewordervacation.component.scss']
})
export class ReviewordervacationComponent implements OnInit {
  ...
  ngOnInit() {
	...
	orderstatus: [this.product.model],
  ...
  goBack(id) {
	...
	getComponentTitle() {
		let result = 'new Review Order Vacation';
