...
@Component({
  selector: 'kt-registerrcollectivevacation',
  templateUrl: './registerrcollectivevacation.component.html',
  styleUrls: ['./registerrcollectivevacation.component.scss']
})
export class RegisterrcollectivevacationComponent implements OnInit {
  ...
  goBack(id) {
	...
	getComponentTitle() {
		let result = 'new Register Collective Vacation';
