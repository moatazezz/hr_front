...
@Component({
  selector: 'kt-trainingcourses',
  templateUrl: './trainingcourses.component.html',
  styleUrls: ['./trainingcourses.component.scss']
})
export class TrainingcoursesComponent implements OnInit {
  ...
  ngOnInit() {
    this.AVAILABLE_JOB=['doctor','engineer','artist','singer','player','nurse'];
    ...
    period: [this.product.model, Validators.required],
  ...
  goBack(id) {
	...
	getComponentTitle() {
		let result = 'new training course';
